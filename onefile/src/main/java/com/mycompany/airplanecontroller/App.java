...
public class App extends Application {
    ...
    public void start(Stage stage) throws FileNotFoundException {
        ...
        Label label1 = new Label("Airplane 1");
        label1.setTranslateX(520);
        label1.setTranslateY(-270);
        label1.setTextFill(javafx.scene.paint.Color.WHITE);
        
         Label label2 = new Label("Airplane 2");
        label2.setTranslateX(-520);
        label2.setTranslateY(-270);
        label2.setTextFill(javafx.scene.paint.Color.WHITE);

        // Set the size of the StackPane to match the objectImg
        StackPane stackPane = new StackPane();
        stackPane.getChildren().addAll(background1,background2, object1, airplane1,airplane2 , label1,label2);
